...
KinD (Kubernetes in Docker) runs a fully functional Kubernetes cluster inside Docker containers on your local machine. This directory provides two setup paths:
...
- **Option B — VM / EC2 Instance:** Installs tools directly on Ubuntu and creates the cluster manually. Ideal for practising on a cloud VM.
